  ...
  return (
    <PageLayout>
      ...
      <div className='container mx-auto text-white text-justify flex flex-col gap-4 mt-10'>
        ...
        <h2 id="privacy-policy" className='text-blue-300 font-[spacemono] font-medium text-2xl'>Privacy Policy</h2>
        ...
        <h3 id="information-collection-and-use" className='text-blue-300 font-[spacemono] font-medium'>INFORMATION COLLECTION AND USE</h3>
        ...
        <h3 id="log-data" className='text-blue-300 font-[spacemono] font-medium'>LOG DATA</h3>
        ...
        <h3 id="cookies" className='text-blue-300 font-[spacemono] font-medium'>COOKIES</h3>
        ...
        <h3 id="service-providers" className='text-blue-300 font-[spacemono] font-medium'>SERVICE PROVIDERS</h3>
        ...
        <h3 id="security" className='text-blue-300 font-[spacemono] font-medium'>SECURITY</h3>
        <p>We value your trust in providing us your Personal Information. Thus we are striving to use commercially acceptable means of protecting it. But remember that no method of transmission over the internet, or method of electronic storage is 100% secure and reliable, and we cannot guarantee its absolute security.</p>
        <h3 id="links-to-other-sites" className='text-blue-300 font-[spacemono] font-medium'>LINKS TO OTHER SITES</h3>
        ...
        <h3 id="changes-to-this-privacy-policy" className='text-blue-300 font-[spacemono] font-medium'>CHANGES TO THIS PRIVACY POLICY</h3>
        ...
        <h3 id="contact-us" className='text-blue-300 font-[spacemono] font-medium'>CONTACT US</h3>
        <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to <a href="/contact/">contact us</a>.</p>
        <h2 id="terms" className='text-blue-300 font-[spacemono] font-medium text-2xl'>Terms</h2>
        ...
        <ul className='list-disc ml-6'>
          ...
          <li>You are free to go through the source code of our website which is available at:<br /><a href="https://github.com/csdu/sankalan">https://github.com/csdu/sankalan</a><br /><a href="https://github.com/csdu/sankalan-portal">https://github.com/csdu/sankalan-portal</a></li>
            ...
            <h3 id="terms-of-service-for-sankalan-2022" className='text-blue-300 font-[spacemono] font-medium'>TERMS OF SERVICE FOR SANKALAN 2022</h3>
            ...
            <h2 id="non-discrimination-policy" className='text-blue-300 font-[spacemono] font-medium'>Non-discrimination Policy</h2>
            ...
            <h2 id="event-conduct-and-safety" className='text-blue-300 font-[spacemono] font-medium'>Event Conduct and Safety</h2>
            ...
            <h3 id="what-to-do-if-you-witness-or-are-subjected-to-unacceptable-behavior-" className='text-blue-300 font-[spacemono] font-medium'>What To Do If You Witness or are Subjected to Unacceptable Behavior:</h3>
