  ...
  return (
    <PageLayout>
      ...
      <div className='container mx-auto text-white text-left flex flex-col gap-4 mt-10'>
        ...
        <h2 id="privacy-policy" className='text-sankalan-yellow font-[comicbook] font-medium text-2xl'>Privacy Policy</h2>
        ...
        <h3 id="information-collection-and-use" className='text-sankalan-yellow font-[comicbook] font-medium'>INFORMATION COLLECTION AND USE</h3>
        ...
        <h3 id="log-data" className='text-sankalan-yellow font-[comicbook] font-medium'>LOG DATA</h3>
        ...
        <h3 id="cookies" className='text-sankalan-yellow font-[comicbook] font-medium'>COOKIES</h3>
        ...
        <h3 id="service-providers" className='text-sankalan-yellow font-[comicbook] font-medium'>SERVICE PROVIDERS</h3>
        ...
        <h3 id="security" className='text-sankalan-yellow font-[comicbook] font-medium'>SECURITY</h3>
        <p>We value your trust in providing us your Personal Information. Thus we are striving to use commercially acceptable means of protecting it. But remember that no method of transmission over the internet, or method of electronic storage is 100% secure and reliable, and we cannot guarantee its absolute security.</p>
        <h3 id="links-to-other-sites" className='text-sankalan-yellow font-[comicbook] font-medium'>LINKS TO OTHER SITES</h3>
        ...
        <h3 id="changes-to-this-privacy-policy" className='text-sankalan-yellow font-[comicbook] font-medium'>CHANGES TO THIS PRIVACY POLICY</h3>
        ...
        <h3 id="contact-us" className='text-sankalan-yellow font-[comicbook] font-medium'>CONTACT US</h3>
        <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to <a href="/contact/">contact us</a>.</p>
        <h2 id="terms" className='text-sankalan-yellow font-[comicbook] font-medium text-2xl'>Terms</h2>
        <h3 id="terms-of-use-for-website" className='text-sankalan-yellow font-[comicbook] font-medium'>TERMS OF USE FOR WEBSITE</h3>
        ...
        <ul className='list-disc ml-6'>
          ...
          <li>You are free to go through the source code of our website which is available at:<br /><a href="https://github.com/csdu/sankalan">https://github.com/csdu/sankalan</a><br /><a href="https://github.com/csdu/sankalan-portal">https://github.com/csdu/sankalan-portal</a></li>
            ...
            <h3 id="terms-of-service-for-sankalan" className='text-sankalan-yellow font-[comicbook] font-medium'>TERMS OF SERVICE FOR SANKALAN</h3>
            ...
            <h2 id="non-discrimination-policy" className='text-sankalan-yellow font-[comicbook] font-medium'>Non-discrimination Policy</h2>
            ...
            <h2 id="event-conduct-and-safety" className='text-sankalan-yellow font-[comicbook] font-medium'>Event Conduct and Safety</h2>
            ...
            <h3 id="what-to-do-if-you-witness-or-are-subjected-to-unacceptable-behavior-" className='text-sankalan-yellow font-[comicbook] font-medium'>What To Do If You Witness or are Subjected to Unacceptable Behavior:</h3>
