  ...
  return (
    <PageLayout>
      ...
      <div className='text-center mb-12 hover:scale-110 transition'>
        <Link href={`/downloads/sponsorship-brochure.pdf`} target='_blank' className='shadow-xl uppercase border-white border-4 transition hover:scale-110 text-white from-sankalan-accent-green to-sankalan-accent-blue bg-gradient-to-r text-2xl
